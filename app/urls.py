...
urlpatterns = [
    ...
    path('foodday/', views.foodday, name='foodday'),
    path('popularfoods/', views.popularfoods, name='popularfoods'),

    path('checkout/', views.checkout, name='checkout'),
    path('paymentdone/', views.payment_done, name='paymentdone'),

    path('account/login/', auth_views.LoginView.as_view(template_name='app/login.html', authentication_form=LoginForm), 
    name='login'),
